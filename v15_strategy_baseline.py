...
from v15_core import run_once_nocache, label_of

def run_strategy(workload: List[Dict[str,Any]], shots: int = 256) -> Dict[str, List[Dict[str,Any]]]:
    """
    ...
    t = 0.0
    for it in workload:
        meta = run_once_nocache(it["maker_run"], shots=shots)
